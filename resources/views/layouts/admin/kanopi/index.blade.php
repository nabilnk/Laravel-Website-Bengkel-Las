...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">List Model Kanopi</h2>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($KanopiProducts as $product)                            
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="{{ url('updatemodelkanopi', $product->id) }}"
                                    role="button">Edit</a>
                                <a onclick="confirmation(event)" class="btn btn-danger"
                                    href="{{ url('deletemodelkanopi', $product->id) }}">
                                    Delete
                                </a>
                            </td>
                        </tr>
